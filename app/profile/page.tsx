...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen">
            <div className="mx-auto max-w-2xl px-4 py-8 pt-16 sm:px-6 lg:px-8 lg:pt-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={user?.email || ''}
                                        disabled
                                        className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-500 dark:border-gray-700 dark:bg-gray-900/50 dark:text-gray-400"
                                    />
